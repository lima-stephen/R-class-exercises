...
names(cust_spend_full)
cust_spend_rearr<-cust_spend_full[,c(1,4,6,2,5,3)]
is.na(cust_spend_full)
missingAge<-cust_spend_full[!(is.na(cust_spend_full$Age) |is.na(cust_spend_full$Spend_Amt)),]
